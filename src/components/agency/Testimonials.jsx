...
const testimonials = [
  {
    ...
    image: avatar1,
    content:
      "Gyaan Consultancy has been our partner for web development and digital marketing over the past three years. Their team delivered a responsive website that boosted our online traffic, and their SEO strategy increased our lead generation by 50%. I highly recommend Gyaan Consultancy to anyone seeking top-notch digital solutions.",
  },
  {
    name: "Jane Smith",
    ...
    image: avatar2,
    content:
      "We engaged Gyaan Consultancy for a cross-platform mobile app and UI/UX redesign. Their app development team nailed every feature, and the new interface greatly improved our user engagement. Their ongoing maintenance and support have been exceptional.",
  },
  {
    name: "Mark Johnson",
    ...
    image: avatar3,
    content:
      "Gyaan Consultancy’s digital marketing services transformed our outreach efforts. Their social media campaigns and PPC ads drove a 40% increase in conversions. Plus, their UI/UX design expertise gave our platform a modern, intuitive look. Couldn’t be happier with the results.",
  },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-2 my-8">
        ...
        <div className="flex flex-col gap-4 px-8">
          <p className="text-xl tracking-normal">
            At Gyaan Consultancy, we pride ourselves on delivering exceptional
